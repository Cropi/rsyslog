...
#define USTR_EQUALS(var) ((pOld->var == NULL) ? (pNew->var == NULL) : (pNew->var != NULL && !ustrcmp(pOld->var, pNew->var)))
#define STR_EQUALS(var) ((pOld->var == NULL) ? (pNew->var == NULL) : (pNew->var != NULL && !strcmp(pOld->var, pNew->var)))
